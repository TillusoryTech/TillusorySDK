...
// 屏幕宽高
#define TiPSScreenWidth [[UIScreen mainScreen] bounds].size.width
#define TiPSScreenHeight [[UIScreen mainScreen] bounds].size.height

/**
 * UI机型适配器
 * 需要在AppDelegate中调用
 */
@interface TiPSAdapter : NSObject
